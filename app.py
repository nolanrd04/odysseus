...
async def _startup_event():
    ...
    #
    # Includes a pre-warm of the RAG tool index: loading the local embedding
    # model + opening ChromaDB + indexing the built-in tools is a one-time
    # ~1-3s cost that otherwise lands on the user's FIRST message (showing up
    # as a big `tool_selection` time). When enabled, doing it here makes the
