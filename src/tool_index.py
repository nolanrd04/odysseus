...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "dwg_corpus_lookup": "Look up past DWG/CAD takeoff jobs during a DWG-to-quantity-sheet extraction: list known jobs, the canonical qty_tbl row vocabulary, census fingerprints (layer/block names) for finding the closest drawing-convention analog, or a specific past job's completed takeoff sheet. Use before mapping extracted quantities to the template.",
